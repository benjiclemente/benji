...
pA="<a href=\"https://benjicb.wordpress.com/\">";
pB="</a>";
...
finalMsg= [	
		...
		"<br>De todas formas, "+pA+"aquí"+pB+" tienes mi portfolio por si te aburres y quieres echarle un vistazo.",

		"COMPAÑERO DE CLASE<br>	Hola, bienvenido, me encanta tener colegas cerca. Espero que puedas disfrutar de "+pA+"mi trabajo"+pB+" e incluso darme feedback si lo consideras necesario.",
		...
		"Aunque haya aprendido contigo, a continuación encontrarás un "+pA+"portfolio creativo"+pB+" en el que, por mucho que me esfuerce, nunca conseguiré trasladar todas las cosas que has visto y has sentido en tu relación conmigo y con mi manera de trabajar."+
		"De cualquier modo, y aprovechando que has llegado hasta aquí, quiero agradecerte infinitamente la confianza que has depositado en mí.<br>"+
		"Gracias y disfruta.",
		
		"QUIERES COLABORAR CONMIGO<br>"+
		"Una de las razones por la que me gusta tanto lo que hago es porque me permite colaborar con gente diversa, de diverso y notable talento. Si tú eres uno de ellos me gustaría conocerte. "+pA+"Aquí"+pB+" encontrarás mi portfolio y en él la manera de ponerte en contacto conmigo.<br>"+
		...
		"Y para que no tengas que fiarte sólo de mi palabra, aquí te ofrezco "+pA+"mis trabajos"+pB+" para que veas que muchas de esas locuras que me ves hacer a veces tienen cierto sentido (o al menos eso me gusta creer a mí).",
		...
		"No quiero añadir ninguna presión a la que ya debes soportar, pero debo decirte que tengo mucha confianza en poder aprender grandes cosas de ti. <br>Esta profesión, como tantas otras, está viviendo un profundo proceso de transformación que va a necesitar de gente con mucho talento y con capacidad para inventar, para imaginar. Capacidades que podría aportar en tu agencia.<br>"+
		...
		"No tienes nada que ver conmigo y sin saber cómo has llegado aquí. Quizá por error, o por destino, o porque en algún momento de tu navegación, y por alguna extraña razón, te he interesado. Incluso es posible que ni siquiera sea la primera vez.<br>"+
		"La cuestión es que has llegado a una web muy poco, cómo decirlo, muy poco web. Esto en realidad solo es un portal de bienvenida a "+pA+"mi portfolio"+pB+", donde puedes seguir investigando, que seguro que encuentras algo que te parezca curioso."
	];	
